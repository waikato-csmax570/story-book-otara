    ...
    index.map(async (url, i) => {
      ...
      return {
        ...
        sprite: {
          ...
          answerReactionMode: "simple",
          answerReactionPreset: "warm",
        },
        puzzle: {
          enabled: false,
          rows: 3,
    ...
    pages: book.pages.map((page, index) => {
      ...
      return {
        ...
        sprite: {
          ...
          reactionPreset: page.sprite?.reactionPreset === "encouraging" ? "warm" : page.sprite?.reactionPreset || "warm",
          reactionMode: page.sprite?.reactionMode || "ai",
          greetingMode: page.sprite?.greetingMode || page.sprite?.reactionMode || "ai",
          customGreetingPresets: page.sprite?.customGreetingPresets || {},
          answerReactionMode: page.sprite?.answerReactionMode || "simple",
          answerReactionPreset: page.sprite?.answerReactionPreset || "warm",
        },
        puzzle: {
